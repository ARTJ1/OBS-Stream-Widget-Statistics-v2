...
const SKINS_JS = path.join(__dirname, '..', '..', 'web', 'admin', 'skins.js');
const ROLE_ASSETS = path.join(__dirname, '..', '..', 'web', 'overlay', 'assets', 'roles');
...
const ROLE_PNG = {
  tank: path.join(ROLE_ASSETS, 'tank.png'),
  support: path.join(ROLE_ASSETS, 'support.png'),
  damage: path.join(ROLE_ASSETS, 'damage.png')
};
